namespace SisWebServer.Server.Routing
{
    using Contracts;
    using Enums;
    using Handlers;
    ...
    public class AppRouteConfig : IAppRouteConfig
    {
        ...
        public void Put(string route, Func<IHttpRequest, IHttpResponse> handler)
        {
            this.AddRoute(route, HttpRequestMethod.Put, new RequestHandler(handler));
        }

        public void Delete(string route, Func<IHttpRequest, IHttpResponse> handler)
        {
            this.AddRoute(route, HttpRequestMethod.Delete, new RequestHandler(handler));
        }
